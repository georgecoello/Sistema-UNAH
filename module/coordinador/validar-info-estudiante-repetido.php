...
<head>
    ...
    <title>Validar Información Repetido</title>
...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-right color-bnav" id="sidebar-wrapper">
            ...
            <input type="hidden" id="estado-info" estado='4'>
                    ...
                    <div class="col-1"></div>
                        <div class="pt-1 pb-2 mb-2 text-white text-center col-9" style='border-radius: 5px;  background-color: #1e6091'> 
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <a href="#" class="btn btn-warning naranja m-2 col-11 sombra-corta3 btn-sm" role="button" style='border-radius: 5px;'> <small><strong> Validar información Repetidos</strong> </small></a>
                                </div>
                            </div> 
                        </div>
                    <div class="col-1"></div>
            ...
            <div class="container px-4 centrar" >
                <div class="container pt-4 pb-2 mt-4 mb-2 fadeInDown" style="border-radius: 5px; background-color: #E8EEF4; box-shadow: 0 30px 60px 0 rgba(0,0,0,0.3); ">
                    ...
                    <div class="row align-items-end">
                        <div class="col-1"></div>
                        <div class="col-10">
                            <small class='text-muted'>Repetidos</small>
                            <h3 class="bg-dark text-center " style="border-radius: 5px;"> <p style="color:white;" id='numero-estudiantes'></p></h3>
                        </div>
                        <div class="col-1"></div>
                    </div>
    ...
    <!--MODAL PARA VALIDAR LA INFORMACION DEL ESTUDIANTE-->
    <div class="modal fade modal-usuario" id="verificar-user">
        <div class="modal-dialog">
            <div class="modal-content">
        
                <!-- Modal Header -->
                <div class="modal-header">
                <h4 class="modal-title" >VERIFICAR INFORMACIÓN DE ESTUDIANTE</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
        
                <!-- Modal body -->
                <div class="modal-body">
                    <form id="validar-info">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="cuenta" placeholder="Numero de Cuenta" class="form-control" disabled>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="carrera" placeholder="Carrera" class="form-control" disabled>
                        </div>

                        <div class="form-group">
                            <label for="excelencia">¿Pertenece a excelencia académica?</label>
                            <input type="text" id="excelencia" placeholder="Excelencia" class="form-control" disabled>
                        </div>

                        <label for="excelencia">¿Esta bien la información?</label>
                        <div class="form-row pb-2">
                            <div class="col-2">
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="customRadio1" name="estado-info" class="custom-control-input" checked="">
                                    <label class="custom-control-label" for="customRadio1" value="1">Si</label>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="customRadio2" name="estado-info" class="custom-control-input">
                                    <label class="custom-control-label" for="customRadio2" value="3">No</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="comentario">Comentario (¿Por que esta mal la información?):</label>
                        ...
                        <div id="boton-modal">
                            <div class="row">
                                <div class="col-6">
                                    <button type="button" class="btn btn-warning btn-block" id='no-validar'>Enviar Rectificar</button>
                                </div>
                                <div class="col-6">
                                    <button type="button" class="btn btn-success btn-block" id='si-validar'>Validar información</button>
                                </div>
                            </div>
    ...
    <script src="../../Resources/js/validar-info-estudiante.js"></script>
