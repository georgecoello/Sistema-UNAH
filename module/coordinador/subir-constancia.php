...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-right color-bnav" id="sidebar-wrapper">
            ...
            <input type="hidden" id="estado-info" estado='1'>
                ...
                <div class="row text-center">
                    <div class="col-1"></div>
                        <div class="pt-1 pb-2 mb-2 text-white text-center col-9" style='border-radius: 5px; background-color: #199cc3'> 
                            ...
                            <div class="row">
                                <div class="col">
                                    <a href="#" class="btn btn-warning naranja m-2 col-11 btn-sm sombra-corta3" role="button" style='border-radius: 5px;'> <small><strong>Subir Constancias</strong> </small></a>
                                </div>
                            </div> 
                            <div class="row">
                                <div class="col">
    ...
    <script src="../../Resources/js/subir-expediente.js"></script>
