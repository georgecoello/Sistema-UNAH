...
<head>
    ...
    <title>Revisar Expedientes</title>
                ...
                <div class="row text-center">
                    <div class="col-1"></div>
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col">
                                    <a href="#" class="btn btn-warning naranja m-2 col-11 btn-sm sombra-corta3" role="button" style='border-radius: 5px;'> <small><strong>Solicitudes nuevas</strong> </small></a>
                                </div>
                            </div> 
                            <div class="row">
                                <div class="col">
