...
<head>
    ...
    <title>Revisar Expedientes Repetidos</title>
...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-right color-bnav" id="sidebar-wrapper">
            ...
            <input type="hidden" id="estado-expediente" estado='4'>

            <?php
                if(isset($_GET['validacion'])){
                    if(strcmp($_GET['validacion'],'2') == 0){
                        echo "<input type='hidden' id='validacion-estudiante' validacion='2'>";
                    } else {
                        echo "<input type='hidden' id='validacion-estudiante' validacion='1'>";
                    }
                ...
                <div class="row text-center">
                    <div class="col-1"></div>
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col">
                                    <a href="#" class="btn btn-warning btn-sm naranja m-2 col-11 sombra-corta3" role="button" style='border-radius: 5px;'> <small><strong>Solicitudes repetidas</strong> </small></a>
                                </div>
                            </div> 
                            <div class="row">
                                <div class="col">
                ...
                <div class="container pt-4 pb-2 mt-4 mb-2 fadeInDown"  style="border-radius: 5px; background-color: #E8EEF4; box-shadow: 0 30px 60px 0 rgba(0,0,0,0.3); ">
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-10">
                            ...
                            <h3 class="bg-dark text-center " style="border-radius: 5px;"> <p style="color:white;" id='numero-expedientes'>Expedientes</p></h3>
                        </div>
                        <div class="col-1"></div>
                    </div>
    ...
    <script src="../../Resources/js/revisar-expediente.js"></script>
