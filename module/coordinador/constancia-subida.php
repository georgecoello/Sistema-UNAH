...
<head>
    ...
    <title>Constancias Subidas</title>
...
<body>
                ...
                <div class="row text-center">
                    <div class="col-1"></div>
                        <div class="pt-1 pb-2 mb-2 text-white text-center col-9" style='border-radius: 5px; background-color: #199cc3'> 
                            ...
                            <div class="row">
                                <div class="col">
                                    <a href="#" class="btn btn-warning naranja m-2 col-11 btn-sm sombra-corta3" role="button" style='border-radius: 5px;'> <small><strong>Subidas</strong> </small></a>
                                </div>
                            </div>
                        </div>
                    <div class="col-1"></div>
    ...
    <script src="../../Resources/js/constancia-subidas.js"></script>
