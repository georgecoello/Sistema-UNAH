    ...
    $.get("../../controller/coordinador/obtener-links-documentos.php", getData, function (e) {
        ...
        if (documentos == 'Fallo'){
            ...
            if (documentos.length !== 0){
                ...
                var docsOcultosValidos=0;
                var docsOcultosInvalidos=0;
                ...
                let n_valida=x_valida-docsOcultosValidos;
                let n_invalida=x_invalida-docsOcultosInvalidos;
                let estado_soli = documentos[0].estado_solicitud;

                validarCantidadRevisados(n_valida,n_invalida,estudianteExce, estado_soli);
...
function validarCantidadRevisados(n_validos, n_invalidos,estudianteExce,estado_soli){
    ...
    if (estado_soli == "4"){
        ...
        if (filasTabla == n_total){
            ...
            toastr["success"]("Valide cada campo para poder visualizar el boton de rectificar o el boton de validar");
        }
    }else{
        toastr["warning"]("Ups! Ha ocurrido un error el estado de la solicitud ha cambiado inesperadamente.");
    }
...
$("#enviar-rectificar").click(function () { 
    ...
    $.post("../../controller/coordinador/invalidar-solicitud.php", postData, function (e) {
        ...
        if(respuesta == "Fallo1"){
            ...
            toastr["success"]("Se ha validado ha rectificar la solicitud.");
